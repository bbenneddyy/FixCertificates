...
import Downloadcertificate from "@/components/certificate/Downloadcertificate"; // Import component if necessary
      ...
      <div className="bg-white">
            ...
            <div className="text-center">
              ...
              <div className="mt-10 flex items-center justify-center gap-x-6">
                <Link
                  ...
                  className={
                    webStatus === "open"
                      ? "rounded-md bg-green-600 px-6 py-2.5 text-xl font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600"
                      : "rounded-md bg-slate-200 px-6 py-2.5 text-xl text-gray-300 font-semibold pointer-events-none"
                  }
                >
        ...
        <div className="flex justify-center p-4 ">
          <div className="mb-4 p-4">
            <Downloadcertificate name={"โคอาล่าาาาาาา"} lastname={"มาร์ช"} />
          </div>
        </div>
      </div>
    </>
