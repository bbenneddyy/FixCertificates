      ...
      <div className="bg-white">
        <div className="relative isolate px-6 pt-14 lg:px-8">
          ...
          >
            {/* green background */}
            <div
              className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#16a34a] to-[#22c55e] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
              style={{
                clipPath:
